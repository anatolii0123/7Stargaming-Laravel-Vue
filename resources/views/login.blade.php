...
<head>
    ...
    <meta content="BetModule" name="author" />
            ...
            <div class="col-md-8 col-lg-6 col-xl-4">
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        ...
                        <p class="text-white-50">Contact for <a href="mailto:info@betmodule.com?Subject=BackOffice%Contact" class="text-white ml-1"><b>info@betmodule.com</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
...
<footer class="footer footer-alt text-white-50">
    2016 - <script>document.write(new Date().getFullYear())</script> &copy; Betting Software by <a href="https://www.betmodule.com" class="text-white-50">BetModule</a>
</footer>
