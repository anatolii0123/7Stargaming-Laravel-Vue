...
function ($) {
    ...
    Topbar.prototype.initMenu = function() {
        // Serach Toggle
        $(document).on('click', '.btn-top-search-popup', function (e) {
            $('.search-dropdown-popup').addClass('d-block');
        });
...
!function ($) {
    ...
    Components.prototype.initShowPassword = function () {
        $(document).on('click', "[attr-password]", function() {
            if($(this).attr('attr-password') == "false"){
                $(this).siblings("input").attr("type", "text");
                $(this).attr('attr-password', 'true');
                $(this).addClass("show-password");
            } else {
                $(this).siblings("input").attr("type", "password");
                $(this).attr('attr-password', 'false');
